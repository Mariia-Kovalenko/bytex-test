...
export const HERO_BULLET_POINTS = [
    {
        id: "11",
        icon: "./sun-icon.svg",
        alt: "sun",
...
export const BENEFITS = [
    {
        ...
        adipiscing elit. Fusce lobortis sapien
        facilisis tincidunt pellentesque. In eget
        ipsum et felis finibus consequat.`,
    },
    {
        id: "002",
        name: "Responsibly made.",
        icon: "./leaf-icon.svg",
        alt: "leaf",
        text: `Lorem ipsum dolor sit amet, consectetur
        adipiscing elit. Fusce lobortis sapien
